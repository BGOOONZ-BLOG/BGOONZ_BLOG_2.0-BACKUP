...
let driver = new webdriver.Builder().usingServer('http://hub-cloud.browserstack.com/wd/hub').withCapabilities(capabilities).build();
...
driver.sleep(2000).then(function () {
    driver.getTitle().then(function (title) {
        if (title === 'webdriver - Google Search') {
            ...
            request({
                uri: 'https://chrismills4:DoDmjvSzK5eLSmAtVwi4@www.browserstack.com/automate/sessions/' + sessionId + '.json',
                method: 'PUT',
