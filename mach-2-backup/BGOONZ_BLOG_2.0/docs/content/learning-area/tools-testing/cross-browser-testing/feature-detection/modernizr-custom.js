...
!(function (window, document, undefined) {
    ...
    function addTest(A, e) {
        if ('object' == typeof A) for (var t in A) hasOwnProp(A, t) && addTest(t, A[t]);
            ...
            (e = 'function' == typeof e ? e() : e),
                1 == n.length
                    ? (Modernizr[n[0]] = e)
                    : (!Modernizr[n[0]] || Modernizr[n[0]] instanceof Boolean || (Modernizr[n[0]] = new Boolean(Modernizr[n[0]])), (Modernizr[n[0]][n[1]] = e)),
    ...
    function testProps(A, e, t, n) {
        ...
        for (var o, d, a, s, l, c = ['modernizr', 'tspan', 'samp']; !mStyle.style && c.length; )
            (o = !0), (mStyle.modElem = createElement(c.shift())), (mStyle.style = mStyle.modElem.style);
    ...
    function testPropsAll(A, e, t, n, r) {
        ...
        return is(e, 'string') || is(e, 'undefined')
            ? testProps(o, e, n, r)
            : ((o = (A + ' ' + domPrefixes.join(i + ' ') + i).split(' ')), testDOMProps(o, e, t));
    }
    ...
    (ModernizrProto._prefixes = prefixes), Modernizr.addTest('dataview', 'undefined' != typeof DataView && 'getFloat64' in DataView.prototype);
    ...
    isSVG ||
        !(function (A, e) {
            ...
            function o(A, t, n) {
                ...
                var r;
                return (
                    (r = n.cache[A] ? n.cache[A].cloneNode() : m.test(A) ? (n.cache[A] = n.createElem(A)).cloneNode() : n.createElem(A)),
                    ...
                    (A.innerHTML = '<xyz></xyz>'),
                        ...
                        (c =
                            ...
                            (function () {
                                ...
                                return (
                                    'undefined' == typeof A.cloneNode || 'undefined' == typeof A.createDocumentFragment || 'undefined' == typeof A.createElement
                                );
                            })());
                } catch (t) {
                    (l = !0), (c = !0);
        ...
        Modernizr.addAsyncTest(function () {
            ...
            try {
                ...
                Modernizr._config.usePrefix &&
                    ((t = t || window.MozBlobBuilder || window.WebKitBlobBuilder || window.MSBlobBuilder || window.OBlobBuilder),
    ...
    Modernizr.addTest('todataurljpeg', function () {
        ...
        Modernizr.addTest('cssgradients', function () {
            for (
                var A, e = 'background-image:', t = 'gradient(linear,left top,right bottom,from(#9f9),to(white));', n = '', r = 0, i = prefixes.length - 1;
                i > r;
                r++
            )
            ...
            return (
                ...
                42 == s
                    ...
                    : (docElement.appendChild(n),
                      ...
                      l.height > 0 && l.height !== a.height && 0 === a.height && (t = !0)),
                (i = o = r = n = undefined),
                t
            );
        }),
        ...
        Modernizr.addTest('ruby', function () {
            function A(A, e) {
                ...
                return (
                    window.getComputedStyle
                        ? (t = document.defaultView.getComputedStyle(A, null).getPropertyValue(e))
            ...
            return (
                ...
                'none' == A(r, i) || ('ruby' == A(t, i) && 'ruby-text' == A(n, i)) || ('6pt' == A(r, o) && '6pt' == A(n, o)) ? (e(), !0) : (e(), !1)
            );
        }),
        ...
        Modernizr.addAsyncTest(function () {
            function A(o) {
                ...
                return !d && n > r
                    ...
                    : (i.removeEventListener('playing', A, !1), addTest('videoautoplay', d), void i.parentNode.removeChild(i));
            }
            var e,
                t = 200,
                n = 5,
    ...
    blacklist
        ...
        testStyles(
            '#modernizr{overflow: scroll; width: 40px; height: 40px; }#' +
                prefixes.join('scrollbar{width:0px} #modernizr::').split('#').slice(1).join('#') +
                'scrollbar{width:0px}',
            function (A) {
            ...
            inputElem.setAttribute('type', (e = A[o])),
                ...
                n &&
                    ...
                    /^range$/.test(e) && inputElem.style.WebkitAppearance !== undefined
                        ...
                        : /^(search|tel)$/.test(e) ||
                          (n = /^(url|email)$/.test(e) ? inputElem.checkValidity && inputElem.checkValidity() === !1 : inputElem.value != i)),
                (inputs[A[o]] = !!n);
        return inputs;
    })(inputtypes)),
    ...
    Modernizr.addTest('svgclippaths', function () {
        ...
        Modernizr.addTest('svgforeignobject', function () {
            return (
                !!document.createElementNS && /SVGForeignObject/.test(toStringFn.call(document.createElementNS('http://www.w3.org/2000/svg', 'foreignObject')))
            );
        }),
    ...
    (url = url && window[url]),
        ...
        (function () {
            ...
            for (
                var A,
                    e,
                    t = ['Width', 'Span', 'Fill', 'Gap', 'Rule', 'RuleColor', 'RuleStyle', 'RuleWidth', 'BreakBefore', 'BreakAfter', 'BreakInside'],
                    n = 0;
                n < t.length;
                n++
            )
        ...
        Modernizr.addTest('cssfilters', function () {
            ...
            var A = createElement('a');
            return (
                (A.style.cssText = prefixes.join('filter:blur(2px); ')), !!A.style.length && (document.documentMode === undefined || document.documentMode > 9)
            );
        }),
                ...
                function t() {
                    try {
                        ...
                        return (
                            ...
                            (r = e.offsetWidth),
                            (t.cssText =
                                'position:absolute;top:0;left:0;width:5em;text-align:justify;text-justification:newspaper;' + prefixes.join('hyphens:auto; ')),
                ...
                function n(A, e) {
                    try {
                        ...
                        return (
                            ...
                            (n.innerHTML = 'm' + A + 'm'),
                            (d = n.offsetHeight > i),
                            e ? ((n.innerHTML = 'm<br />m'), (i = n.offsetWidth), (n.innerHTML = 'm' + A + 'm'), (a = n.offsetWidth > i)) : (a = !0),
                            d === !0 && a === !0 && (o = !0),
                    ...
                    try {
                        ...
                        (n.innerHTML = r + A + r),
                            ...
                            t.setSelectionRange
                                ...
                                : t.createTextRange &&
                                  ((e = t.createTextRange()), e.collapse(!0), e.moveEnd('character', 0), e.moveStart('character', 0), e.select());
                        try {
        ...
        Modernizr.addTest('csstransforms3d', function () {
            ...
            if (A && (!e || 'webkitPerspective' in docElement.style)) {
                ...
                Modernizr.supports ? (t = '@supports (perspective: 1px)') : ((t = '@media (transform-3d)'), e && (t += ',(-webkit-transform-3d)')),
